                ...
                {isOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                        <motion.div
                            ...
                            className={`border backdrop-blur-md rounded-2xl p-6 max-w-md w-full shadow-2xl relative ${theme === 'light'
                        ...
                        >
                            <button
                                ...
                                className={`absolute top-4 right-4 hover:text-primary-500 transition-colors ${theme === 'light' ? 'text-slate-400' : 'text-slate-500'
                                    }`}
                            >
                                ✕
                            </button>
                            ...
                            <div className="text-center mb-6">
                                ...
                                <p className={`text-sm mt-2 ${theme === 'light' ? 'text-slate-500' : 'text-slate-400'}`}>
                                    {isRTL
                            ...
                            {success ? (
                                <div className="text-center py-8">
                                    ...
                                    <p className={`font-bold ${theme === 'light' ? 'text-slate-800' : 'text-white'}`}>
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        <label className={`text-xs font-medium ${theme === 'light' ? 'text-slate-500' : 'text-slate-400'}`}>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            className={`flex min-h-[100px] w-full rounded-md border px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 ${theme === 'light'
