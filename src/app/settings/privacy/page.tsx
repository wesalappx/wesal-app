...
import { ArrowRight, Shield, Eye, Database, Clock, Check } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-b from-surface-900 via-surface-800 to-surface-900">
            ...
            <main className="max-w-lg mx-auto px-4 py-8">
                ...
                >
                    ...
                    <button
                        onClick={handleSave}
                        className="w-full py-4 bg-gradient-to-r from-primary-500 to-accent-500 hover:from-primary-600 hover:to-accent-600 rounded-xl text-white font-bold text-lg transition-all shadow-lg shadow-primary-500/25"
                    >
                        حفظ الإعدادات
                    </button>
